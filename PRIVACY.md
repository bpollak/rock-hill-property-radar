...
- OneHome is supported only through sanitized snapshots. Access tokens, token-bearing URLs, contact identifiers, and private email addresses are rejected by validation and must never be committed.
